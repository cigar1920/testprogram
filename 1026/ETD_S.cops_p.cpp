...
int main(int argc, char *argv[]) {
  ...
  while (temp_var_for_ext_0) {
    ...
    computeDMul((Addr)&temp_var_for_tac_149,
                {(Addr) &(temp_var_for_const_124 = Alpha[1]),
    ...
    computeDAdd((Addr)&temp_var_for_tac_151,
                {(Addr) &(temp_var_for_const_125 = 1.0), (Addr)&k},
    ...
    for (i = 0; i < N; i++) {
      ...
      temp_var_for_ext_1 = temp_var_for_tac_222 + temp_var_for_tac_230;
      ...
      computeDAdd((Addr)&temp_var_for_ext_1,
      ...
      AssignD({(Addr)&C[i]}, (Addr)&temp_var_for_ext_1,
