...
int main(int argc, char *argv[]) {
  ...
  computeDDiv2((Addr)&temp_var_for_tac_2, (Addr)&temp_var_for_tac_0,
               (Addr)&temp_var_for_tac_1, "toString(biExpr->getExprLoc())");
  computeDSub2((Addr)&temp_var_for_tac_0, (Addr) &(temp_var_for_const_1 = 0.0),
               (Addr)&EMvac, "toString(biExpr->getExprLoc())");
  computeDMul2((Addr)&temp_var_for_tac_1, (Addr) &(temp_var_for_const_3 = KB),
  ...
  computeDMul2(
      (Addr)&Dvac, (Addr) &(temp_var_for_const_4 = 1.0e-6),
      (Addr)&temp_var_for_callexp_0,
      "toString(biExpr->getExprLoc())"); // m^2/s。1.0e-6*exp(-EMvac/(KB*T))m^2/s
  ...
  double temp_var_for_tac_3, temp_var_for_tac_4, temp_var_for_tac_5,
      temp_var_for_tac_6;
  computeDDiv2((Addr)&temp_var_for_tac_6, (Addr) &(temp_var_for_const_9 = 1.0),
  ...
  computeDDiv2((Addr)&temp_var_for_tac_4, (Addr)&temp_var_for_tac_3, (Addr)&Vat,
               "toString(biExpr->getExprLoc())");
  computeDDiv2((Addr)&temp_var_for_tac_5, (Addr)&temp_var_for_tac_4, (Addr)&Vat,
               "toString(biExpr->getExprLoc())");
  ...
  computeDMul2((Addr)&Alpha0, (Addr)&temp_var_for_callexp_1, (Addr)&Dvac,
               "toString(biExpr->getExprLoc())");
  ...
  for (i = 0; i < N; i++) {
    ...
    computeDDiv2((Addr)&temp_var_for_tac_11,
                 (Addr) &(temp_var_for_const_16 = 1.0),
                 (Addr) &(temp_var_for_const_15 = 3.0),
                 "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_7, (Addr) &(temp_var_for_const_11 = i),
    ...
    computeDMul2((Addr)&temp_var_for_tac_9, (Addr) &(temp_var_for_const_14 = 4),
                 (Addr) &(temp_var_for_const_13 = PI),
                 "toString(biExpr->getExprLoc())");
    computeDDiv2((Addr)&temp_var_for_tac_10, (Addr)&temp_var_for_tac_8,
                 (Addr)&temp_var_for_tac_9, "toString(biExpr->getExprLoc())");
    ...
    computeDMul2((Addr)&r[i], (Addr)&temp_var_for_callexp_2,
                 (Addr) &(temp_var_for_const_17 = 1.0),
                 "toString(biExpr->getExprLoc())"); // nm
    ...
    computeDDiv2((Addr)&temp_var_for_tac_13, (Addr)&temp_var_for_tac_12,
                 (Addr)&r[i], "toString(biExpr->getExprLoc())");
    computeDSub2((Addr)&EBvac[i], (Addr)&EFvac, (Addr)&temp_var_for_tac_13,
                 "toString(biExpr->getExprLoc())"); // eV空位缺陷结合能
    Alpha[i] =
    ...
    computeDDiv2((Addr)&temp_var_for_tac_15,
                 (Addr) &(temp_var_for_const_22 = 1.0),
                 (Addr) &(temp_var_for_const_21 = 3.0),
                 "toString(biExpr->getExprLoc())");
    computeDDiv2((Addr)&temp_var_for_tac_19, (Addr)&temp_var_for_tac_17,
                 (Addr)&temp_var_for_tac_18, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_14,
    ...
    computeDMul2((Addr)&temp_var_for_tac_16, (Addr)&Alpha0,
                 (Addr)&temp_var_for_callexp_3,
                 "toString(biExpr->getExprLoc())");
    computeDSub2((Addr)&temp_var_for_tac_17,
                 (Addr) &(temp_var_for_const_23 = 0.0), (Addr)&EBvac[i],
                 "toString(biExpr->getExprLoc())");
    computeDMul2(
        (Addr)&temp_var_for_tac_18, (Addr) &(temp_var_for_const_25 = KB),
        (Addr) &(temp_var_for_const_24 = T), "toString(biExpr->getExprLoc())");
    ...
    computeDMul2((Addr)&Alpha[i], (Addr)&temp_var_for_tac_16,
                 (Addr)&temp_var_for_callexp_4,
                 "toString(biExpr->getExprLoc())");
    ...
    computeDDiv2((Addr)&temp_var_for_tac_21,
                 (Addr) &(temp_var_for_const_29 = 1.0),
                 (Addr) &(temp_var_for_const_28 = 3.0),
                 "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_20,
    ...
    computeDMul2((Addr)&Beta[i], (Addr)&Beta0, (Addr)&temp_var_for_callexp_5,
                 "toString(biExpr->getExprLoc())"); //公式2
    if (i == 0) {
      L3[0] = (0.0 - pow((1.0 + k), -3));
      double temp_var_for_const_30, temp_var_for_const_31;
      double temp_var_for_tac_22;
      computeDAdd2((Addr)&temp_var_for_tac_22,
      ...
      computeDSub2((Addr)&L3[0], (Addr) &(temp_var_for_const_31 = 0.0),
      ...
      double temp_var_for_tac_23, temp_var_for_tac_24, temp_var_for_tac_25,
          temp_var_for_tac_26;
      computeDDiv2((Addr)&temp_var_for_tac_26, (Addr)&temp_var_for_tac_25,
                   (Addr) &(temp_var_for_const_34 = 2),
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_23,
                   (Addr) &(temp_var_for_const_32 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_24,
                   (Addr) &(temp_var_for_const_33 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_25, (Addr)&temp_var_for_tac_23,
      ...
      computeDDiv2((Addr)&temp_var_for_tac_30, (Addr)&temp_var_for_tac_29,
                   (Addr) &(temp_var_for_const_37 = 2),
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_27,
                   (Addr) &(temp_var_for_const_35 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_28,
                   (Addr) &(temp_var_for_const_36 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_29, (Addr)&temp_var_for_tac_27,
      ...
      computeDSub2(
          (Addr)&temp_var_for_tac_31, (Addr) &(temp_var_for_const_38 = 1.0),
          (Addr)&temp_var_for_callexp_8, "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_32,
                   (Addr) &(temp_var_for_const_39 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDDiv2((Addr)&phi2[0], (Addr)&temp_var_for_tac_31,
      ...
      computeDMul2((Addr)&temp_var_for_tac_35, (Addr)&temp_var_for_tac_33,
                   (Addr)&temp_var_for_tac_34,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_33,
                   (Addr) &(temp_var_for_const_40 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_34,
      ...
      computeDMul2((Addr)&temp_var_for_tac_42, (Addr)&temp_var_for_tac_40,
                   (Addr)&temp_var_for_tac_41,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_36,
                   (Addr) &(temp_var_for_const_43 = 0.0),
                   (Addr) &(temp_var_for_const_42 = 4.0),
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_37,
                   (Addr) &(temp_var_for_const_44 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_38, (Addr)&dt,
                   (Addr)&temp_var_for_tac_37,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_39, (Addr)&temp_var_for_tac_36,
                   (Addr)&temp_var_for_tac_38,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_40,
                   (Addr) &(temp_var_for_const_45 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_41,
                   (Addr) &(temp_var_for_const_46 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_43,
                   (Addr) &(temp_var_for_const_47 = 3.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_44,
                   (Addr) &(temp_var_for_const_48 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_45, (Addr)&temp_var_for_tac_43,
                   (Addr)&temp_var_for_tac_44,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2(
          (Addr)&temp_var_for_tac_46, (Addr) &(temp_var_for_const_49 = 4),
          (Addr)&temp_var_for_tac_45, "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_47, (Addr)&dt, (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_48,
                   (Addr) &(temp_var_for_const_50 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_49, (Addr)&temp_var_for_tac_47,
                   (Addr)&temp_var_for_tac_48,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_50,
                   (Addr) &(temp_var_for_const_51 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_51, (Addr)&temp_var_for_tac_49,
      ...
      computeDAdd2((Addr)&temp_var_for_tac_52, (Addr)&temp_var_for_tac_46,
                   (Addr)&temp_var_for_tac_51,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_53, (Addr)&temp_var_for_callexp_10,
                   (Addr)&temp_var_for_tac_52,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&poly1[0], (Addr)&temp_var_for_tac_39,
      ...
      computeDMul2((Addr)&temp_var_for_tac_60, (Addr)&temp_var_for_tac_58,
                   (Addr)&temp_var_for_tac_59,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_54,
                   (Addr) &(temp_var_for_const_52 = 2.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_55,
                   (Addr) &(temp_var_for_const_53 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_56, (Addr)&temp_var_for_tac_54,
                   (Addr)&temp_var_for_tac_55,
                   "toString(biExpr->getExprLoc())");
      computeDSub2(
          (Addr)&temp_var_for_tac_57, (Addr) &(temp_var_for_const_54 = 4.0),
          (Addr)&temp_var_for_tac_56, "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_58,
                   (Addr) &(temp_var_for_const_55 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_59,
                   (Addr) &(temp_var_for_const_56 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_61,
                   (Addr) &(temp_var_for_const_57 = 2.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_62,
                   (Addr) &(temp_var_for_const_58 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_63, (Addr)&temp_var_for_tac_61,
      ...
      computeDSub2(
          (Addr)&temp_var_for_tac_64, (Addr) &(temp_var_for_const_59 = (-(4))),
          (Addr)&temp_var_for_tac_63, "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_65, (Addr)&temp_var_for_callexp_11,
                   (Addr)&temp_var_for_tac_64,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&poly2[0], (Addr)&temp_var_for_tac_57,
      ...
      computeDMul2((Addr)&temp_var_for_tac_79, (Addr)&temp_var_for_tac_77,
                   (Addr)&temp_var_for_tac_78,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_66,
                   (Addr) &(temp_var_for_const_61 = 0.0),
                   (Addr) &(temp_var_for_const_60 = 4.0),
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_67,
                   (Addr) &(temp_var_for_const_62 = 3.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_68,
                   (Addr) &(temp_var_for_const_63 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_69, (Addr)&temp_var_for_tac_67,
                   (Addr)&temp_var_for_tac_68,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_70, (Addr)&temp_var_for_tac_66,
                   (Addr)&temp_var_for_tac_69,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_71, (Addr)&dt, (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_72,
                   (Addr) &(temp_var_for_const_64 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_73, (Addr)&temp_var_for_tac_71,
                   (Addr)&temp_var_for_tac_72,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_74,
                   (Addr) &(temp_var_for_const_65 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_75, (Addr)&temp_var_for_tac_73,
                   (Addr)&temp_var_for_tac_74,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_76, (Addr)&temp_var_for_tac_70,
                   (Addr)&temp_var_for_tac_75,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_77,
                   (Addr) &(temp_var_for_const_66 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_78,
                   (Addr) &(temp_var_for_const_67 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_80,
                   (Addr) &(temp_var_for_const_68 = 1.0), (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_81, (Addr)&dt,
      ...
      computeDAdd2(
          (Addr)&temp_var_for_tac_82, (Addr) &(temp_var_for_const_69 = 4),
          (Addr)&temp_var_for_tac_81, "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_83, (Addr)&temp_var_for_callexp_12,
                   (Addr)&temp_var_for_tac_82,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&poly3[0], (Addr)&temp_var_for_tac_76,
      ...
      computeDAdd2((Addr)&temp_var_for_tac_84, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      ...
      computeDSub2((Addr)&L3[i], (Addr) &(temp_var_for_const_70 = 0.0),
      ...
      double temp_var_for_tac_85, temp_var_for_tac_86, temp_var_for_tac_87,
          temp_var_for_tac_88;
      computeDDiv2((Addr)&temp_var_for_tac_88, (Addr)&temp_var_for_tac_87,
                   (Addr) &(temp_var_for_const_72 = 2),
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_85,
                   (Addr) &(temp_var_for_const_71 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_86, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_87, (Addr)&temp_var_for_tac_85,
      ...
      computeDDiv2((Addr)&temp_var_for_tac_92, (Addr)&temp_var_for_tac_91,
                   (Addr) &(temp_var_for_const_74 = 2),
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_89,
                   (Addr) &(temp_var_for_const_73 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_90, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_91, (Addr)&temp_var_for_tac_89,
      ...
      computeDSub2(
          (Addr)&temp_var_for_tac_93, (Addr) &(temp_var_for_const_75 = 1.0),
          (Addr)&temp_var_for_callexp_15, "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_94, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDDiv2((Addr)&phi2[i], (Addr)&temp_var_for_tac_93,
      ...
      computeDMul2((Addr)&temp_var_for_tac_97, (Addr)&temp_var_for_tac_95,
                   (Addr)&temp_var_for_tac_96,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_95,
                   (Addr) &(temp_var_for_const_76 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_96, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      ...
      computeDMul2((Addr)&temp_var_for_tac_104, (Addr)&temp_var_for_tac_102,
                   (Addr)&temp_var_for_tac_103,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_98,
                   (Addr) &(temp_var_for_const_78 = 0.0),
                   (Addr) &(temp_var_for_const_77 = 4.0),
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_99, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_100, (Addr)&dt,
                   (Addr)&temp_var_for_tac_99,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_101, (Addr)&temp_var_for_tac_98,
                   (Addr)&temp_var_for_tac_100,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_102,
                   (Addr) &(temp_var_for_const_79 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_103, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_105,
                   (Addr) &(temp_var_for_const_80 = 3.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_106, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_107, (Addr)&temp_var_for_tac_105,
                   (Addr)&temp_var_for_tac_106,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2(
          (Addr)&temp_var_for_tac_108, (Addr) &(temp_var_for_const_81 = 4),
          (Addr)&temp_var_for_tac_107, "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_109, (Addr)&dt, (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_110, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_111, (Addr)&temp_var_for_tac_109,
                   (Addr)&temp_var_for_tac_110,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_112, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_113, (Addr)&temp_var_for_tac_111,
      ...
      computeDAdd2((Addr)&temp_var_for_tac_114, (Addr)&temp_var_for_tac_108,
                   (Addr)&temp_var_for_tac_113,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_115, (Addr)&temp_var_for_callexp_17,
                   (Addr)&temp_var_for_tac_114,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&poly1[i], (Addr)&temp_var_for_tac_101,
      ...
      computeDMul2((Addr)&temp_var_for_tac_122, (Addr)&temp_var_for_tac_120,
                   (Addr)&temp_var_for_tac_121,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_116,
                   (Addr) &(temp_var_for_const_82 = 2.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_117, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_118, (Addr)&temp_var_for_tac_116,
                   (Addr)&temp_var_for_tac_117,
                   "toString(biExpr->getExprLoc())");
      computeDSub2(
          (Addr)&temp_var_for_tac_119, (Addr) &(temp_var_for_const_83 = 4.0),
          (Addr)&temp_var_for_tac_118, "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_120,
                   (Addr) &(temp_var_for_const_84 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_121, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_123,
                   (Addr) &(temp_var_for_const_85 = 2.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_124, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_125, (Addr)&temp_var_for_tac_123,
      ...
      computeDSub2(
          (Addr)&temp_var_for_tac_126, (Addr) &(temp_var_for_const_86 = (-(4))),
          (Addr)&temp_var_for_tac_125, "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_127, (Addr)&temp_var_for_callexp_18,
                   (Addr)&temp_var_for_tac_126,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&poly2[i], (Addr)&temp_var_for_tac_119,
      ...
      computeDMul2((Addr)&temp_var_for_tac_141, (Addr)&temp_var_for_tac_139,
                   (Addr)&temp_var_for_tac_140,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_128,
                   (Addr) &(temp_var_for_const_88 = 0.0),
                   (Addr) &(temp_var_for_const_87 = 4.0),
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_129,
                   (Addr) &(temp_var_for_const_89 = 3.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_130, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_131, (Addr)&temp_var_for_tac_129,
                   (Addr)&temp_var_for_tac_130,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_132, (Addr)&temp_var_for_tac_128,
                   (Addr)&temp_var_for_tac_131,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_133, (Addr)&dt, (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_134, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_135, (Addr)&temp_var_for_tac_133,
                   (Addr)&temp_var_for_tac_134,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_136, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_137, (Addr)&temp_var_for_tac_135,
                   (Addr)&temp_var_for_tac_136,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_138, (Addr)&temp_var_for_tac_132,
                   (Addr)&temp_var_for_tac_137,
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_139,
                   (Addr) &(temp_var_for_const_90 = 0.0), (Addr)&dt,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_140, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_142, (Addr)&Alpha[i], (Addr)&k,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_143, (Addr)&dt,
      ...
      computeDAdd2(
          (Addr)&temp_var_for_tac_144, (Addr) &(temp_var_for_const_91 = 4),
          (Addr)&temp_var_for_tac_143, "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_145, (Addr)&temp_var_for_callexp_19,
                   (Addr)&temp_var_for_tac_144,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&poly3[i], (Addr)&temp_var_for_tac_138,
  ...
  while (temp_var_for_ext_0) {
    ...
    for (i = 0; i < N; i++) {
      if (i == 0) {
        ...
        alpha[i] = Alpha[i] * C[i];
        computeDMul2((Addr)&alpha[i], (Addr)&Alpha[i], (Addr)&C[i],
                     "toString(biExpr->getExprLoc())");
    ...
    computeDSub2((Addr)&temp_var_for_tac_147, (Addr)&temp_var_for_tac_146,
                 (Addr)&sumbeta, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_148, (Addr)&temp_var_for_tac_147,
                 (Addr)&sumalpha, "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_149, (Addr)&Alpha[1], (Addr)&C[1],
                 "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_150, (Addr)&temp_var_for_tac_148,
                 (Addr)&temp_var_for_tac_149, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_151,
                 (Addr) &(temp_var_for_const_95 = 1.0), (Addr)&k,
                 "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_152, (Addr)&temp_var_for_tac_151,
                 (Addr)&C[0], "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&Fc[0], (Addr)&temp_var_for_tac_150,
                 (Addr)&temp_var_for_tac_152, "toString(biExpr->getExprLoc())");
    for (i = 1; i <= N - 2; i++) {
      ...
      computeDSub2((Addr)&temp_var_for_tac_155, (Addr)&temp_var_for_tac_153,
                   (Addr)&temp_var_for_tac_154,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_156, (Addr)&Alpha[i + 1],
                   (Addr)&C[i + 1], "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_157, (Addr)&temp_var_for_tac_155,
                   (Addr)&temp_var_for_tac_156,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_158, (Addr)&k, (Addr)&C[i],
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&Fc[i], (Addr)&temp_var_for_tac_157,
    ...
    for (i = 0; i < N; i++) {
      ...
      computeDMul2((Addr)&temp_var_for_tac_160, (Addr)&k, (Addr)&C[N - 1],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_161, (Addr)&phi1[i], (Addr)&C[i],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_162, (Addr)&phi2[i], (Addr)&Fc[i],
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&a[i], (Addr)&temp_var_for_tac_161,
      ...
      if (i == 0) {
        ...
        computeDMul2((Addr)&alpha_a[i], (Addr)&Alpha[i], (Addr)&a[i],
                     "toString(biExpr->getExprLoc())");
    ...
    computeDSub2((Addr)&temp_var_for_tac_164, (Addr)&temp_var_for_tac_163,
                 (Addr)&sumbeta_a, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_165, (Addr)&temp_var_for_tac_164,
                 (Addr)&sumalpha_a, "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_166, (Addr)&Alpha[1], (Addr)&a[1],
                 "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_167, (Addr)&temp_var_for_tac_165,
                 (Addr)&temp_var_for_tac_166, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_168,
                 (Addr) &(temp_var_for_const_99 = 1.0), (Addr)&k,
                 "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_169, (Addr)&temp_var_for_tac_168,
                 (Addr)&a[0], "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&Fa[0], (Addr)&temp_var_for_tac_167,
                 (Addr)&temp_var_for_tac_169, "toString(biExpr->getExprLoc())");
    for (i = 1; i <= N - 2; i++) {
      ...
      computeDSub2((Addr)&temp_var_for_tac_172, (Addr)&temp_var_for_tac_170,
                   (Addr)&temp_var_for_tac_171,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_173, (Addr)&Alpha[i + 1],
                   (Addr)&a[i + 1], "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_174, (Addr)&temp_var_for_tac_172,
                   (Addr)&temp_var_for_tac_173,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_175, (Addr)&k, (Addr)&a[i],
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&Fa[i], (Addr)&temp_var_for_tac_174,
    ...
    computeDMul2((Addr)&temp_var_for_tac_176, (Addr)&Beta[N - 2],
                 (Addr)&a[N - 2], "toString(biExpr->getExprLoc())");
    /*for(i=0;i<N;i++){
            printf("Fa[%d]=%e\n",i,Fa[i]);
    }*/
    ...
    for (i = 0; i < N; i++) {
      ...
      computeDMul2((Addr)&temp_var_for_tac_177, (Addr)&k, (Addr)&a[N - 1],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_178, (Addr)&phi1[i], (Addr)&C[i],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_179, (Addr)&phi2[i], (Addr)&Fa[i],
                   "toString(biExpr->getExprLoc())");
      if (i == 0) {
        alpha_b[i] = 0.0;
        computeDAdd2((Addr)&alpha_b[i], (Addr)&temp_var_for_tac_178,
        ...
        computeDMul2((Addr)&alpha_b[i], (Addr)&Alpha[i], (Addr)&b[i],
                     "toString(biExpr->getExprLoc())");
    ...
    computeDSub2((Addr)&temp_var_for_tac_181, (Addr)&temp_var_for_tac_180,
                 (Addr)&sumbeta_b, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_182, (Addr)&temp_var_for_tac_181,
                 (Addr)&sumalpha_b, "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_183, (Addr)&Alpha[1], (Addr)&b[1],
                 "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_184, (Addr)&temp_var_for_tac_182,
                 (Addr)&temp_var_for_tac_183, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_185,
                 (Addr) &(temp_var_for_const_102 = 1.0), (Addr)&k,
                 "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_186, (Addr)&temp_var_for_tac_185,
                 (Addr)&b[0], "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&Fb[0], (Addr)&temp_var_for_tac_184,
                 (Addr)&temp_var_for_tac_186, "toString(biExpr->getExprLoc())");
    for (i = 1; i <= N - 2; i++) {
      ...
      computeDSub2((Addr)&temp_var_for_tac_189, (Addr)&temp_var_for_tac_187,
                   (Addr)&temp_var_for_tac_188,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_190, (Addr)&Alpha[i + 1],
                   (Addr)&b[i + 1], "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_191, (Addr)&temp_var_for_tac_189,
                   (Addr)&temp_var_for_tac_190,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_192, (Addr)&k, (Addr)&b[i],
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&Fb[i], (Addr)&temp_var_for_tac_191,
    ...
    computeDMul2((Addr)&temp_var_for_tac_193, (Addr)&Beta[N - 2],
                 (Addr)&b[N - 2], "toString(biExpr->getExprLoc())");
    /*for(i=0;i<N;i++){
            printf("Fb[%d]=%e\n",i,Fb[i]);
    }*/
    ...
    for (i = 0; i < N; i++) {
      ...
      computeDMul2((Addr)&temp_var_for_tac_194, (Addr)&k, (Addr)&b[N - 1],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_195, (Addr)&phi1[i], (Addr)&a[i],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_196,
                   (Addr) &(temp_var_for_const_103 = 2), (Addr)&Fb[i],
                   "toString(biExpr->getExprLoc())");
      computeDSub2((Addr)&temp_var_for_tac_197, (Addr)&temp_var_for_tac_196,
                   (Addr)&Fc[i], "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_198, (Addr)&phi2[i],
                   (Addr)&temp_var_for_tac_197,
                   "toString(biExpr->getExprLoc())");
      if (i == 0) {
        alpha_d[i] = 0.0;
        computeDAdd2((Addr)&alpha_d[i], (Addr)&temp_var_for_tac_195,
        ...
        computeDMul2((Addr)&alpha_d[i], (Addr)&Alpha[i], (Addr)&d[i],
                     "toString(biExpr->getExprLoc())");
    ...
    computeDSub2((Addr)&temp_var_for_tac_200, (Addr)&temp_var_for_tac_199,
                 (Addr)&sumbeta_d, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_201, (Addr)&temp_var_for_tac_200,
                 (Addr)&sumalpha_d, "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_202, (Addr)&Alpha[1], (Addr)&d[1],
                 "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_203, (Addr)&temp_var_for_tac_201,
                 (Addr)&temp_var_for_tac_202, "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&temp_var_for_tac_204,
                 (Addr) &(temp_var_for_const_106 = 1.0), (Addr)&k,
                 "toString(biExpr->getExprLoc())");
    computeDMul2((Addr)&temp_var_for_tac_205, (Addr)&temp_var_for_tac_204,
                 (Addr)&d[0], "toString(biExpr->getExprLoc())");
    computeDAdd2((Addr)&Fd[0], (Addr)&temp_var_for_tac_203,
                 (Addr)&temp_var_for_tac_205, "toString(biExpr->getExprLoc())");
    for (i = 1; i <= N - 2; i++) {
      ...
      computeDSub2((Addr)&temp_var_for_tac_208, (Addr)&temp_var_for_tac_206,
                   (Addr)&temp_var_for_tac_207,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_209, (Addr)&Alpha[i + 1],
                   (Addr)&d[i + 1], "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_210, (Addr)&temp_var_for_tac_208,
                   (Addr)&temp_var_for_tac_209,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_211, (Addr)&k, (Addr)&d[i],
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&Fd[i], (Addr)&temp_var_for_tac_210,
    ...
    computeDMul2((Addr)&temp_var_for_tac_212, (Addr)&Beta[N - 2],
                 (Addr)&d[N - 2], "toString(biExpr->getExprLoc())");
    /*for(i=0;i<N;i++){
            printf("Fd[%d]=%e\n",i,Fd[i]);
    }*/
    ...
    for (i = 0; i < N; i++) {
      ...
      computeDMul2((Addr)&temp_var_for_tac_214, (Addr)&phi3[i], (Addr)&C[i],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_213, (Addr)&k, (Addr)&d[N - 1],
                   "toString(biExpr->getExprLoc())");
      ...
      computeDMul2((Addr)&temp_var_for_tac_215, (Addr)&temp_var_for_callexp_20,
                   (Addr)&L3[i], "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_216, (Addr)&poly1[i], (Addr)&Fc[i],
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_217, (Addr)&Fa[i], (Addr)&Fb[i],
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_218, (Addr)&poly2[i],
                   (Addr)&temp_var_for_tac_217,
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_219, (Addr)&temp_var_for_tac_216,
                   (Addr)&temp_var_for_tac_218,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_220, (Addr)&poly3[i], (Addr)&Fd[i],
                   "toString(biExpr->getExprLoc())");
      computeDAdd2((Addr)&temp_var_for_tac_221, (Addr)&temp_var_for_tac_219,
                   (Addr)&temp_var_for_tac_220,
                   "toString(biExpr->getExprLoc())");
      computeDMul2((Addr)&temp_var_for_tac_222, (Addr)&temp_var_for_tac_215,
                   (Addr)&temp_var_for_tac_221,
                   "toString(biExpr->getExprLoc())"); // C[i]
      ...
      computeDAdd2((Addr)&C[i], (Addr)&temp_var_for_tac_214,
                   (Addr)&temp_var_for_tac_222,
                   "toString(biExpr->getExprLoc())");
    }
    double temp_var_for_ext_2;
    temp_var_for_ext_2 = t + dt;
    computeDAdd2((Addr)&temp_var_for_ext_2, (Addr)&t, (Addr)&dt,
                 "toString(biExpr->getExprLoc())"); // t
  ...
  computeDSub2((Addr)&temp_var_for_tac_223, (Addr)&end, (Addr)&start,
               "toString(biExpr->getExprLoc())");
  computeDDiv2((Addr)&totaltime, (Addr)&temp_var_for_tac_223,
