...
double __ieee754_sqrt(double x) {
  ...
  AssignD({(Addr)&temp_var_for_ext_0}, (Addr)&z,
          "/home/shijia/Public/testprogram/e_sqrt.c_e.c:194:22");
...
double __sqrt(double x) {
  ...
  temp_var_for_ext_1 = __ieee754_sqrt(x);
  double temp_var_for_callexp_0 =
      __ieee754_sqrt(getFVbyShadow<double>((Addr)&x));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignD({(Addr)&temp_var_for_ext_1}, ,
          "/home/shijia/Public/testprogram/e_sqrt.c_e.c:465:22");
