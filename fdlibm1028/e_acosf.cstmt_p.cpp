...
float __ieee754_acosf(float x) {
  ...
  static const float qS1 = (0.0 - 2.4033949375e+00);
  ...
  static const float qS3 = (0.0 - 6.8828397989e-01);
...
float __acosf(float x) {
  ...
  temp_var_for_ext_0 = __ieee754_acosf(x);
  float temp_var_for_callexp_0 =
      __ieee754_acosf(getFVbyShadow<float>((Addr)&x));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignF({(Addr)&temp_var_for_ext_0}, (Addr)&temp_var_for_callexp_0,
          "/home/shijia/Public/testprogram/e_acosf.c_e.c:95:22");
