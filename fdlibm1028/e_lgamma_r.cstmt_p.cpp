...
static double sin_pi(double x) {
   ...
   */
  z = __ieee754_floor(y);
  double temp_var_for_const_1;AssignD({(Addr)&z},(Addr)&(temp_var_for_const_1=__ieee754_floor(getFVbyShadow<int>((Addr)&y)),"/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:107:5");
  if (z != y) { /* inexact anyway */
    y *= 0.5;
    double temp_var_for_ext_0;
    temp_var_for_ext_0 = 2.0 * (y - __ieee754_floor(y));
    double temp_var_for_const_2, temp_var_for_const_3;
    double temp_var_for_tac_0;computeDSub((Addr)&temp_var_for_tac_0,{(Addr)&y,(Addr)&(temp_var_for_const_2=__ieee754_floor(getFVbyShadow<int>((Addr)&y))},"/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:111:30");
    computeDMul(
        (Addr)&temp_var_for_ext_0,
        {(Addr) &(temp_var_for_const_3 = 2.0), (Addr)&temp_var_for_tac_0},
        "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:111:24"); // y
    /*(0.5)(y)(__ieee754_floor(y))(y)(2.0)*/
    y = temp_var_for_ext_0;
    AssignD({(Addr)&y}, (Addr)&temp_var_for_ext_0,
            "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:113:7"); /* y =
                                                                          |x|
                                                                          mod
                                                                          2.0 */
    n = (int32_t)(y * 4.0);
  ...
  temp_var_for_ext_1 = -y;AssignD({(Addr)&temp_var_for_ext_1},(Addr)&(-(y)),"/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:172:22");
...
double __ieee754_lgamma_r(double x, int *signgamp) {
  ...
  static const double tf = (0.0 - 1.21486290535849611461e-01);
  double temp_var_for_const_6, temp_var_for_const_7;
  ; /* 0xBFBF19B9, 0xBCC38A42 */
  /* tt = -(tail of tf) */
  static const double tt = (0.0 - 3.63867699703950536541e-18);
  ...
  computeDSub((Addr)&temp_var_for_tac_2,
              {(Addr) &(temp_var_for_const_7 = 0.0),
               (Addr) &(temp_var_for_const_6 = 1.21486290535849611461e-01)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:220:12");
  ; /* 0xBC50C7CA, 0xA48A971F */
  static const double t0 =
      4.83836122723810047042e-01; /* 0x3FDEF72B, 0xC8EE38A2 */
  static const double t1 = (0.0 - 1.47587722994593911752e-01);
  ...
  computeDSub((Addr)&temp_var_for_tac_3,
              {(Addr) &(temp_var_for_const_9 = 0.0),
               (Addr) &(temp_var_for_const_8 = 3.63867699703950536541e-18)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:224:12");
  ; /* 0xBFC2E427, 0x8DC6C509 */
  static const double t2 =
      6.46249402391333854778e-02; /* 0x3FB08B42, 0x94D5419B */
  static const double t3 = (0.0 - 3.27885410759859649565e-02);
  ...
  computeDSub((Addr)&temp_var_for_tac_4,
              {(Addr) &(temp_var_for_const_11 = 0.0),
               (Addr) &(temp_var_for_const_10 = 1.47587722994593911752e-01)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:228:12");
  ; /* 0xBFA0C9A8, 0xDF35B713 */
  static const double t4 =
      1.79706750811820387126e-02; /* 0x3F9266E7, 0x970AF9EC */
  static const double t5 = (0.0 - 1.03142241298341437450e-02);
  ...
  computeDSub((Addr)&temp_var_for_tac_5,
              {(Addr) &(temp_var_for_const_13 = 0.0),
               (Addr) &(temp_var_for_const_12 = 3.27885410759859649565e-02)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:232:12");
  ; /* 0xBF851F9F, 0xBA91EC6A */
  static const double t6 =
      6.10053870246291332635e-03; /* 0x3F78FCE0, 0xE370E344 */
  static const double t7 = (0.0 - 3.68452016781138256760e-03);
  ...
  computeDSub((Addr)&temp_var_for_tac_6,
              {(Addr) &(temp_var_for_const_15 = 0.0),
               (Addr) &(temp_var_for_const_14 = 1.03142241298341437450e-02)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:236:12");
  ; /* 0xBF6E2EFF, 0xB3E914D7 */
  static const double t8 =
      2.25964780900612472250e-03; /* 0x3F6282D3, 0x2E15C915 */
  static const double t9 = (0.0 - 1.40346469989232843813e-03);
  ...
  computeDSub((Addr)&temp_var_for_tac_7,
              {(Addr) &(temp_var_for_const_17 = 0.0),
               (Addr) &(temp_var_for_const_16 = 3.68452016781138256760e-03)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:240:12");
  ; /* 0xBF56FE8E, 0xBF2D1AF1 */
  static const double t10 =
      8.81081882437654011382e-04; /* 0x3F4CDF0C, 0xEF61A8E9 */
  static const double t11 = (0.0 - 5.38595305356740546715e-04);
  ...
  computeDSub((Addr)&temp_var_for_tac_8,
              {(Addr) &(temp_var_for_const_19 = 0.0),
               (Addr) &(temp_var_for_const_18 = 1.40346469989232843813e-03)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:244:12");
  ; /* 0xBF41A610, 0x9C73E0EC */
  static const double t12 =
      3.15632070903625950361e-04; /* 0x3F34AF6D, 0x6C0EBBF7 */
  static const double t13 = (0.0 - 3.12754168375120860518e-04);
  ...
  computeDSub((Addr)&temp_var_for_tac_9,
              {(Addr) &(temp_var_for_const_21 = 0.0),
               (Addr) &(temp_var_for_const_20 = 5.38595305356740546715e-04)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:248:12");
  ; /* 0xBF347F24, 0xECC38C38 */
  static const double t14 =
      3.35529192635519073543e-04; /* 0x3F35FD3E, 0xE8C2D3F4 */
  static const double u0 = (0.0 - 7.72156649015328655494e-02);
  ...
  computeDSub((Addr)&temp_var_for_tac_10,
              {(Addr) &(temp_var_for_const_23 = 0.0),
               (Addr) &(temp_var_for_const_22 = 3.12754168375120860518e-04)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:252:12");
  ...
  static const double s0 = (0.0 - 7.72156649015328655494e-02);
  ...
  computeDSub((Addr)&temp_var_for_tac_11,
              {(Addr) &(temp_var_for_const_25 = 0.0),
               (Addr) &(temp_var_for_const_24 = 7.72156649015328655494e-02)},
  ...
  static const double w2 = (0.0 - 2.77777777728775536470e-03);
  ...
  computeDSub((Addr)&temp_var_for_tac_12,
              {(Addr) &(temp_var_for_const_27 = 0.0),
               (Addr) &(temp_var_for_const_26 = 7.72156649015328655494e-02)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:304:12");
  ; /* 0xBF66C16C, 0x16B02E5C */
  static const double w3 =
      7.93650558643019558500e-04; /* 0x3F4A019F, 0x98CF38B6 */
  static const double w4 = (0.0 - 5.95187557450339963135e-04);
  ...
  computeDSub((Addr)&temp_var_for_tac_13,
              {(Addr) &(temp_var_for_const_29 = 0.0),
               (Addr) &(temp_var_for_const_28 = 2.77777777728775536470e-03)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:308:12");
  ; /* 0xBF4380CB, 0x8C0FE741 */
  static const double w5 =
      8.36339918996282139126e-04; /* 0x3F4B67BA, 0x4CDAD5D1 */
  static const double w6 = (0.0 - 1.63092934096575273989e-03);
  ...
  computeDSub((Addr)&temp_var_for_tac_14,
              {(Addr) &(temp_var_for_const_31 = 0.0),
               (Addr) &(temp_var_for_const_30 = 5.95187557450339963135e-04)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:312:12");
  ...
  *signgamp = 1;
  ...
  } else if (ix < IC(0x40200000)) { /* x < 8.0 */
    i = (int32_t)x;
    t = zero;
    y = x - (double)i;
    p = y *
  ...
  computeDSub((Addr)&temp_var_for_ext_2,
              {(Addr) &(temp_var_for_const_33 = 0.0),
               (Addr) &(temp_var_for_const_32 = 1.63092934096575273989e-03)},
              "/home/shijia/Public/testprogram/e_lgamma_r.c_e.c:438:22");
