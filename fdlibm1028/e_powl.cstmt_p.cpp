...
long double __ieee754_powl(long double x, long double y) {
  ...
  long double temp_var_for_const_0;AssignLd({(Addr)&d},(Addr)&(temp_var_for_const_0=__ieee754_truncl(getFVbyShadow<int>((Addr)&y)),"/home/shijia/Public/testprogram/e_powl.c_e.c:156:5");
  if (d != y) {
    if (signbit(x)) {
      long double temp_var_for_ext_0;
      temp_var_for_ext_0 = -__builtin_nanl("");
      AssignLd({(Addr)&temp_var_for_ext_0},
               (Addr) & (-(temp_var_for_callexp_0)),
               "/home/shijia/Public/testprogram/e_powl.c_e.c:160:26");
      callExpStack.push(
          getReal("temp_var_for_ext_0", (Addr)&temp_var_for_ext_0));
      callExp++; /*identify the function is  add move tmpShadow*/
      return (0.0 - temp_var_for_ext_0);
      long double temp_var_for_const_1;
      ;
      long double temp_var_for_tac_0;
      computeLdSub(
          (Addr)&temp_var_for_tac_0,
          {(Addr) &(temp_var_for_const_1 = 0.0), (Addr)&temp_var_for_ext_0},
          "toString(biExpr->getExprLoc())");
    }
    if (y == 0.5L) {
      long double temp_var_for_ext_1;
      temp_var_for_ext_1 = __ieee754_sqrtl(x);
      long double temp_var_for_const_2;AssignLd({(Addr)&temp_var_for_ext_1},(Addr)&(temp_var_for_const_2=__ieee754_sqrtl(getFVbyShadow<int>((Addr)&x)),"/home/shijia/Public/testprogram/e_powl.c_e.c:168:26");
      callExpStack.push(
  ...
  if (signbit(x)) {
    ...
    long double temp_var_for_const_3;AssignLd({(Addr)&y},(Addr)&(temp_var_for_const_3=__ieee754_scalbnl(getFVbyShadow<int>((Addr)&y), ((-(1)))),"/home/shijia/Public/testprogram/e_powl.c_e.c:205:7");
    if (y != __ieee754_truncl(y)) {
      long double temp_var_for_ext_2;
      temp_var_for_ext_2 = (0.0 - rslt);
      long double temp_var_for_const_4;
      computeLdSub(
          (Addr)&temp_var_for_ext_2,
          {(Addr) &(temp_var_for_const_4 = 0.0), (Addr)&rslt},
          "/home/shijia/Public/testprogram/e_powl.c_e.c:208:26"); // rslt
      /*(rslt)(rslt)*/
      rslt = temp_var_for_ext_2;
      AssignLd({(Addr)&rslt}, (Addr)&temp_var_for_ext_2,
               "/home/shijia/Public/testprogram/e_powl.c_e.c:210:12");
    }
  }
  long double temp_var_for_ext_3;
  temp_var_for_ext_3 = rslt;AssignLd({(Addr)&temp_var_for_ext_3},(Addr)&rslt,"/home/shijia/Public/testprogram/e_powl.c_e.c:214:22");
