...
long double __ieee754_sinhl(long double x) {
  ...
  AssignLd({(Addr)&h}, (Addr) &(temp_var_for_const_0 = 0.5),
           "/home/shijia/Public/testprogram/e_sinhl.c_e.c:58:5");
  if (jx & 0x8000)
    h = -h;
  ...
  temp_var_for_ext_0 = x * shuge;
  long double temp_var_for_const_1;
  computeLdMul((Addr)&temp_var_for_ext_0,
               {(Addr)&x, (Addr) &(temp_var_for_const_1 = shuge)},
               "/home/shijia/Public/testprogram/e_sinhl.c_e.c:87:22");
...
long double __sinhl(long double x) {
  ...
  AssignLd({(Addr)&temp_var_for_ext_1}, (Addr)&z,
           "/home/shijia/Public/testprogram/e_sinhl.c_e.c:102:22");
