...
double __ieee754_sqrt(double x) {
  ...
  if ((ix0 & IC(0x7ff00000)) == IC(0x7ff00000)) {
    ...
    computeDMul((Addr)&temp_var_for_tac_0, {(Addr)&x, (Addr)&x},
                "/home/shijia/Public/testprogram/e_sqrt.c_e.c:103:28");
    computeDAdd((Addr)&temp_var_for_tac_1,
                {(Addr)&temp_var_for_tac_0, (Addr)&x},
                "/home/shijia/Public/testprogram/e_sqrt.c_e.c:103:32");
    AssignD({(Addr)&temp_var_for_ext_0}, (Addr)&temp_var_for_tac_1,
            "/home/shijia/Public/testprogram/e_sqrt.c_e.c:103:24");
    ;
  ...
  if (ix0 <= 0) {
    if (((ix0 & (~sign)) | ix1) == 0) {
      ...
      AssignD({(Addr)&temp_var_for_ext_1}, (Addr)&x,
              "/home/shijia/Public/testprogram/e_sqrt.c_e.c:113:26");
      ;
      callExpStack.push(
    ...
    /* sqrt(+-0) = +-0 */
      ...
      if (ix0 < 0) {
        ...
        computeDSub((Addr)&temp_var_for_tac_2, {(Addr)&x, (Addr)&x},
                    "/home/shijia/Public/testprogram/e_sqrt.c_e.c:123:33");
        computeDSub((Addr)&temp_var_for_tac_3, {(Addr)&x, (Addr)&x},
                    "/home/shijia/Public/testprogram/e_sqrt.c_e.c:123:43");
        computeDDiv((Addr)&temp_var_for_tac_4,
                    {(Addr)&temp_var_for_tac_2, (Addr)&temp_var_for_tac_3},
                    "/home/shijia/Public/testprogram/e_sqrt.c_e.c:123:38");
        AssignD({(Addr)&temp_var_for_ext_2}, (Addr)&temp_var_for_tac_4,
                "/home/shijia/Public/testprogram/e_sqrt.c_e.c:123:28");
        ;
        callExpStack.push(
  ...
  temp_var_for_ext_5 = r != 0;
  while (temp_var_for_ext_5) {
    t1 = s1 + r;
    t = s0;
  ...
  if ((ix0 | ix1) != 0) {
    ...
    computeDSub((Addr)&temp_var_for_tac_5,
                ...
                "/home/shijia/Public/testprogram/e_sqrt.c_e.c:208:13");
    AssignD({(Addr)&z}, (Addr)&temp_var_for_tac_5,
            "/home/shijia/Public/testprogram/e_sqrt.c_e.c:208:7");
    ...
    if (int temp_var_for_tac_6; int temp_var_for_const_2;
      ...
      compute((Addr)&temp_var_for_tac_6,
              ...
              "/home/shijia/Public/testprogram/e_sqrt.c_e.c:209:11");
      computeDAdd((Addr)&temp_var_for_tac_7,
                  {(Addr) &(temp_var_for_const_4 = one),
                   (Addr) &(temp_var_for_const_3 = tiny)},
                  "/home/shijia/Public/testprogram/e_sqrt.c_e.c:210:15");
      AssignD({(Addr)&z}, (Addr)&temp_var_for_tac_7,
              "/home/shijia/Public/testprogram/e_sqrt.c_e.c:210:9");
      ;
      if (q1 == UC(0xffffffff)) {
        q1 = 0;
        q += 1;
  ...
  compute((Addr)&temp_var_for_tac_8,
          ...
          "/home/shijia/Public/testprogram/e_sqrt.c_e.c:215:15");
  AssignD({(Addr)&temp_var_for_ext_6}, (Addr)&z,
          "/home/shijia/Public/testprogram/e_sqrt.c_e.c:236:22");
  ;
...
double __sqrt(double x) {
  ...
  AssignD({(Addr)&temp_var_for_ext_8},
          ...
          "/home/shijia/Public/testprogram/e_sqrt.c_e.c:513:22");
  ;
