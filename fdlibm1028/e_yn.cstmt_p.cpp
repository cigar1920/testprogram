...
double __ieee754_yn(int n, double x) {
  ...
  if (n == 0) {
    ...
    temp_var_for_ext_0 = (__ieee754_y0(x));
    double temp_var_for_const_0;AssignD({(Addr)&temp_var_for_ext_0},(Addr)&(temp_var_for_const_0=__ieee754_y0(getFVbyShadow<int>((Addr)&x)),"/home/shijia/Public/testprogram/e_yn.c_e.c:69:24");
  ...
  temp_var_for_ext_1 = -b;
  AssignD({(Addr)&temp_var_for_ext_1}, (Addr) & (-(b)),
          "/home/shijia/Public/testprogram/e_yn.c_e.c:129:22");
...
double __yn(int n, double x) {
  ...
  temp_var_for_ext_2 = __ieee754_yn(n, x);
  double temp_var_for_callexp_0 =
      __ieee754_yn((n), getFVbyShadow<double>((Addr)&x));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignD({(Addr)&temp_var_for_ext_2}, (Addr)&temp_var_for_callexp_0,
          "/home/shijia/Public/testprogram/e_yn.c_e.c:152:22");
