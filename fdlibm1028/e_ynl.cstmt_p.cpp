...
long double __ieee754_ynl(int n, long double x) {
  ...
  if (n == 0) {
    ...
    temp_var_for_ext_0 = (__ieee754_y0l(x));
    long double temp_var_for_const_0;AssignLd({(Addr)&temp_var_for_ext_0},(Addr)&(temp_var_for_const_0=__ieee754_y0l(getFVbyShadow<int>((Addr)&x)),"/home/shijia/Public/testprogram/e_ynl.c_e.c:90:24");
  ...
  if (n == 1) {
    ...
    temp_var_for_ext_1 = (sign * __ieee754_y1l(x));AssignLd({(Addr)&temp_var_for_ext_1},(Addr)&sign * __ieee754_y1l(getFVbyShadow<int>((Addr)&x),"/home/shijia/Public/testprogram/e_ynl.c_e.c:98:24");
  ...
  temp_var_for_ext_3 = -b;
  AssignLd({(Addr)&temp_var_for_ext_3}, (Addr) & (-(b)),
           "/home/shijia/Public/testprogram/e_ynl.c_e.c:164:22");
  ...
  computeDSub((Addr)&temp_var_for_tac_0, {(Addr) &(temp_var_for_const_2 = 0.0),
                                          (Addr) &(temp_var_for_const_1 = 3)},
...
long double __ynl(int n, long double x) {
  ...
  temp_var_for_ext_4 = __ieee754_yn(n, x);
  long double temp_var_for_const_3;AssignLd({(Addr)&temp_var_for_ext_4},(Addr)&(temp_var_for_const_3=__ieee754_yn((n), getFVbyShadow<int>((Addr)&x)),"/home/shijia/Public/testprogram/e_ynl.c_e.c:187:22");
