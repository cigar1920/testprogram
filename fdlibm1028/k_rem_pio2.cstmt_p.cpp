...
recompute:
  ...
  case 0: {
    ...
    AssignD({(Addr)&temp_var_for_ext_1}, (Addr) &(temp_var_for_const_3 = 0.0),
            "/home/shijia/Public/testprogram/k_rem_pio2.c_e.c:318:24"); // fw
    ...
    AssignD({(Addr)&fw}, (Addr)&temp_var_for_ext_1,
            "/home/shijia/Public/testprogram/k_rem_pio2.c_e.c:321:8");
  }
  ...
  case 2: {
    ...
    computeDSub(
        ...
        "/home/shijia/Public/testprogram/k_rem_pio2.c_e.c:336:24"); // fv
    /*(fv)(fq)(0)(fq[0])*/
    fv = temp_var_for_ext_2;
    AssignD({(Addr)&fv}, (Addr)&temp_var_for_ext_2,
            "/home/shijia/Public/testprogram/k_rem_pio2.c_e.c:338:8");
    for (i = 1; i <= jz; i++)
      fv += fq[i];
    y[1] = (ih == 0) ? fv : -fv;
  }
