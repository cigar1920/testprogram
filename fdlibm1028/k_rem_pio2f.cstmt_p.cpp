...
recompute:
  ...
  z -= (float)8.0 * __ieee754_floorf(z * (float)0.125);
  float temp_var_for_const_0;
  float temp_var_for_tac_0;
  computeFMul((Addr)&temp_var_for_tac_0, {(Addr)&z, (Addr) & ((float)0.125)},
  ...
  if (z == zero) {
    ...
    float temp_var_for_tac_1;computeFMul((Addr)&temp_var_for_tac_1,{(Addr)&((float)8.0),(Addr)&(temp_var_for_const_0=__ieee754_floorf(getFVbyShadow<int>((Addr)&temp_var_for_tac_0))},"toString(biExpr->getExprLoc())");
  }
  ...
  case 0: {
    ...
    AssignF({(Addr)&temp_var_for_ext_1}, (Addr) &(temp_var_for_const_1 = 0.0),
            "/home/shijia/Public/testprogram/k_rem_pio2f.c_e.c:216:24"); // fw
    /*(__ieee754_floorf(z * (float) 0.125))(8.0)(8.0)(z)(__ieee754_floorf(z *
     * (float) 0.125))(8.0)(8.0)(0.125)(0.125)(z)(twon8)(fw)(0.0)*/
    fw = temp_var_for_ext_1;
    AssignF({(Addr)&fw}, (Addr)&temp_var_for_ext_1,
            "/home/shijia/Public/testprogram/k_rem_pio2f.c_e.c:219:8");
  }
  ...
  case 2: {
    ...
    computeFSub(
        ...
        {(Addr)&fq[0], (Addr) &(temp_var_for_const_2 = fv)},
        "/home/shijia/Public/testprogram/k_rem_pio2f.c_e.c:234:24"); // fv
    /*(fv)(fq)(0)(fq[0])*/
    fv = temp_var_for_ext_2;
    AssignF({(Addr)&fv}, (Addr)&temp_var_for_ext_2,
            "/home/shijia/Public/testprogram/k_rem_pio2f.c_e.c:236:8");
    for (i = 1; i <= jz; i++)
      fv += fq[i];
    y[1] = (ih == 0) ? fv : -fv;
  }
