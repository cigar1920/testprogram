...
double __ieee754_ceil(double x) {
  ...
  AssignD({(Addr)&temp_var_for_ext_0}, (Addr)&x,
          "/home/shijia/Public/testprogram/s_ceil.c_e.c:82:22");
...
double __ceil(double x) {
  ...
  temp_var_for_ext_1 = __ieee754_ceil(x);
  double temp_var_for_callexp_0 =
      __ieee754_ceil(getFVbyShadow<double>((Addr)&x));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignD({(Addr)&temp_var_for_ext_1}, ,
          "/home/shijia/Public/testprogram/s_ceil.c_e.c:92:22");
