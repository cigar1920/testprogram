...
float __ieee754_ceilf(float x) {
  ...
  if (j0 < IEEE754_FLOAT_SHIFT) {
    if (j0 < 0) {                   /* raise inexact if x != 0 */
      ...
      if ((i0 & i) == 0) {
        ...
        computeFAdd((Addr)&temp_var_for_tac_0,
                    ...
                    "/home/shijia/Public/testprogram/s_ceilf.c_e.c:18:7 "
        ...
        AssignF({(Addr)&temp_var_for_ext_0}, (Addr)&x,
                "/home/shijia/Public/testprogram/s_ceilf.c_e.c:31:28");
        ;
        callExpStack.push(
    ...
    if (j0 == (IEEE754_FLOAT_MAXEXP - IEEE754_FLOAT_BIAS)) {
      ...
      computeFAdd((Addr)&temp_var_for_tac_2,
                  ...
                  "/home/shijia/Public/testprogram/s_ceilf.c_e.c:38:7 "
                  "<Spelling=/home/shijia/Public/testprogram/"
                  "s_ceilf.c_e.c:38:31>");
      ...
      computeFAdd((Addr)&temp_var_for_tac_4, {(Addr)&x, (Addr)&x},
                  "/home/shijia/Public/testprogram/s_ceilf.c_e.c:48:30");
      AssignF({(Addr)&temp_var_for_ext_1}, (Addr)&temp_var_for_tac_4,
              "/home/shijia/Public/testprogram/s_ceilf.c_e.c:48:26");
      ;
      callExpStack.push(
    ...
    /* inf or NaN */
      ...
      AssignF({(Addr)&temp_var_for_ext_2}, (Addr)&x,
              "/home/shijia/Public/testprogram/s_ceilf.c_e.c:57:26");
      ;
      callExpStack.push(
  ...
  AssignF({(Addr)&temp_var_for_ext_3}, (Addr)&x,
          "/home/shijia/Public/testprogram/s_ceilf.c_e.c:67:22");
  ;
...
float __ceilf(float x) {
  ...
  AssignF({(Addr)&temp_var_for_ext_4},
          ...
          "/home/shijia/Public/testprogram/s_ceilf.c_e.c:77:22");
  ;
