...
double __ieee754_cosS(double x) {
  double y[2];
  double z = 0.0;
  int32_t n, ix;
  ...
  /* cos(Inf or NaN) is NaN */
    ...
    if (ix >= IC(0x7ff00000)) {
      ...
      computeDSub((Addr)&temp_var_for_tac_0, {(Addr)&x, (Addr)&x},
                  "/home/shijia/Public/testprogram/s_cos.c_e.c:72:30");
      AssignD({(Addr)&temp_var_for_ext_1}, (Addr)&temp_var_for_tac_0,
              "/home/shijia/Public/testprogram/s_cos.c_e.c:72:26");
      ;
      callExpStack.push(
    ...
    /* argument reduction needed */
      ...
      case 1: {
        ...
        double temp_var_for_const_2,temp_var_for_callexp_2;
        temp_var_for_callexp_2 = __kernel_sin(y[0], y[1], 1);
        temp_var_for_ext_4 = (-(temp_var_for_callexp_2));
        AssignD({(Addr)&temp_var_for_ext_4},
                (Addr) &(temp_var_for_const_2 = (-(temp_var_for_callexp_2))),
                "/home/shijia/Public/testprogram/s_cos.c_e.c:96:28");
        ;
        callExpStack.push(
...
int main()
{
        std::ifstream inputFile("/home/shijia/Public/FpDebug-valgrind_3.12/valgrind/fpdebug/pso/exe-input/cos_t.txt", std::ios::in);
        double input;
        ...
        std::ifstream inputOracle("/home/shijia/Public/FpDebug-valgrind_3.12/valgrind/fpdebug/pso/mpfr/mpfrresults/cos_out.txt", std::ios::in);
        while (inputFile >> input)
        {
                double a = __ieee754_cosS(input);
