...
float __cosf(float x) {
  ...
  float temp_var_for_callexp_0 = __ieee754_cosf(getFVbyShadow<float>((Addr)&x));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignF({(Addr)&ret}, (Addr)&temp_var_for_callexp_0,
          "/home/shijia/Public/testprogram/s_cosf.c_e.c:58:7");
  ...
  AssignF({(Addr)&temp_var_for_ext_0}, (Addr)&ret,
          "/home/shijia/Public/testprogram/s_cosf.c_e.c:62:22");
