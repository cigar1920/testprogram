...
long double __ieee754_cosl(long double x) {
  ...
  AssignLd({(Addr) &(temp_var_for_const_0 = ew_u.value)}, (Addr)&x,
           "/home/shijia/Public/testprogram/s_cosl.c_e.c:62:3 "
  ...
  if (se < 0x3ffe || (se == 0x3ffe && i0 <= UC(0xc90fdaa2))) {
    ...
    temp_var_for_callexp_0 = __kernel_cosl(x, z);
    ...
    AssignLd({(Addr)&temp_var_for_ext_0},
             ...
             "/home/shijia/Public/testprogram/s_cosl.c_e.c:69:24");
    ;
  ...
  /* cos(Inf or NaN) is NaN */
    ...
    if (se == IEEE854_LONG_DOUBLE_MAXEXP) {
      ...
      computeLdSub((Addr)&temp_var_for_tac_0, {(Addr)&x, (Addr)&x},
                   "/home/shijia/Public/testprogram/s_cosl.c_e.c:79:30");
      AssignLd({(Addr)&temp_var_for_ext_1}, (Addr)&temp_var_for_tac_0,
               "/home/shijia/Public/testprogram/s_cosl.c_e.c:79:26");
      ;
      callExpStack.push(
    ...
    /* argument reduction needed */
      ...
      case 0: {
        ...
        temp_var_for_callexp_1 = __kernel_cosl(y[0], y[1]);
        ...
        AssignLd({(Addr)&temp_var_for_ext_3},
                 ...
                 "/home/shijia/Public/testprogram/s_cosl.c_e.c:94:28");
        ;
        callExpStack.push(
      ...
      case 1: {
        ...
        temp_var_for_callexp_2 = __kernel_sinl(y[0], y[1], 1);
        ...
        AssignLd({(Addr)&temp_var_for_ext_4},
                 ...
                 "/home/shijia/Public/testprogram/s_cosl.c_e.c:103:28");
        ;
        callExpStack.push(
      ...
      case 2: {
        ...
        temp_var_for_callexp_3 = __kernel_cosl(y[0], y[1]);
        ...
        AssignLd({(Addr)&temp_var_for_ext_5},
                 ...
                 "/home/shijia/Public/testprogram/s_cosl.c_e.c:112:28");
        ;
        callExpStack.push(
      ...
      default: {
        ...
        AssignLd({(Addr)&temp_var_for_ext_6},
                 ...
                 "/home/shijia/Public/testprogram/s_cosl.c_e.c:121:28");
        ;
        callExpStack.push(
...
long double __cosl(long double x) {
  ...
  AssignLd({(Addr)&temp_var_for_ext_7}, (Addr)&ret,
           "/home/shijia/Public/testprogram/s_cosl.c_e.c:143:22");
  ;
