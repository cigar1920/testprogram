...
float __fdimf(float x, float y) {
  ...
  computeFSub((Addr)&temp_var_for_tac_0, {(Addr)&x, (Addr)&y},
              "/home/shijia/Public/testprogram/s_fdimf.c_e.c:35:9");
  AssignF({(Addr)&r}, (Addr)&temp_var_for_tac_0,
  ...
  AssignF({(Addr)&temp_var_for_ext_1}, (Addr)&r,
          "/home/shijia/Public/testprogram/s_fdimf.c_e.c:42:22");
  ;
