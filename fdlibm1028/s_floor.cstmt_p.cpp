...
double __ieee754_floor(double x) {
  ...
  AssignD({(Addr)&temp_var_for_ext_0}, (Addr)&x,
          "/home/shijia/Public/testprogram/s_floor.c_e.c:80:22");
...
double __floor(double x) {
  ...
  temp_var_for_ext_1 = __ieee754_floor(x);
  double temp_var_for_callexp_0 =
      __ieee754_floor(getFVbyShadow<double>((Addr)&x));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignD({(Addr)&temp_var_for_ext_1}, ,
          "/home/shijia/Public/testprogram/s_floor.c_e.c:90:22");
