...
double __ieee754_frexp(double x, int *eptr) {
  ...
  *eptr += (int)(ix >> 20) - 1022;
  ...
  AssignD({(Addr)&temp_var_for_ext_0}, (Addr)&x,
          "/home/shijia/Public/testprogram/s_frexp.c_e.c:49:22");
...
double __frexp(double x, int *exp) {
  ...
  temp_var_for_ext_1 = __ieee754_frexp(x, exp);
  double temp_var_for_callexp_0 =
      __ieee754_frexp(getFVbyShadow<double>((Addr)&x), (exp));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignD({(Addr)&temp_var_for_ext_1}, ,
          "/home/shijia/Public/testprogram/s_frexp.c_e.c:59:22");
