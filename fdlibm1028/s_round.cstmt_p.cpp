...
double __ieee754_round(double x) {
  ...
  AssignD({(Addr)&temp_var_for_ext_0}, (Addr)&x,
          "/home/shijia/Public/testprogram/s_round.c_e.c:108:22");
...
double __round(double x) {
  ...
  temp_var_for_ext_1 = __ieee754_round(x);
  double temp_var_for_callexp_0 =
      __ieee754_round(getFVbyShadow<double>((Addr)&x));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignD({(Addr)&temp_var_for_ext_1}, ,
          "/home/shijia/Public/testprogram/s_round.c_e.c:118:22");
