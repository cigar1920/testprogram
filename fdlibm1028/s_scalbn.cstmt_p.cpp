...
double __ieee754_scalbn(double x, int n) {
  ...
  temp_var_for_ext_0 = x * twom54;
  double temp_var_for_const_0;
  computeDMul((Addr)&temp_var_for_ext_0,
              {(Addr)&x, (Addr) &(temp_var_for_const_0 = twom54)},
              "/home/shijia/Public/testprogram/s_scalbn.c_e.c:65:22");
...
double __scalbn(double x, int n) {
  ...
  temp_var_for_ext_1 = __ieee754_scalbn(x, n);
  double temp_var_for_callexp_0 =
      __ieee754_scalbn(getFVbyShadow<double>((Addr)&x), (n));
  CallStackPop((Addr)&temp_var_for_callexp_0, getTop(temp_var_for_callexp_0));
  AssignD({(Addr)&temp_var_for_ext_1}, (Addr)&temp_var_for_callexp_0,
          "/home/shijia/Public/testprogram/s_scalbn.c_e.c:75:22");
