  ...
  /* sin(Inf or NaN) is NaN */
    ...
    if (!FLT_UWORD_IS_FINITE(ix)) {
      ...
      computeFSub((Addr)&temp_var_for_tac_0, {(Addr)&x, (Addr)&x},
                  "/home/shijia/Public/testprogram/s_sinf.c_e.c:42:30");
      AssignF({(Addr)&temp_var_for_ext_1}, (Addr)&temp_var_for_tac_0,
              "/home/shijia/Public/testprogram/s_sinf.c_e.c:42:26");
      ;
      callExpStack.push(
...
float __sinf(float x) {
  ...
  AssignF({(Addr)&temp_var_for_ext_7}, (Addr)&ret,
          "/home/shijia/Public/testprogram/s_sinf.c_e.c:106:22");
  ;
